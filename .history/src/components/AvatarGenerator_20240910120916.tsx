...
const accessories: Accessory[] = [
  ...
  { id: 'glasses2', name: 'Sunglasses', image: '/assets/items/barbieglasses2.png', category: 'Glasses' },
  { id: 'glasses3', name: 'Nerd Glasses', image: '/assets/items/nerdglasses.png', category: 'Glasses' },
  { id: 'glasses4', name: 'Barbie Glasses', image: '/generator/barbieglasses2.png', category: 'Glasses' },
  { id: 'hat1', name: 'Bunny Hat', image: '/generator/hatbarbie1.png', category: 'Hats' },
