  ...
  return (
    <div className="w-full py-16 px-4 relative overflow-hidden" ref={roadmapRef}>
      <Image
        ...
        width={550}
        height={550}
        className={`pixelated absolute right-0 top-1/2 transform -translate-y-1/2 transition-all duration-300 ${isMobile ? 'blur-sm' : ''}`}
        style={{ maxWidth: 'none' }}
      />
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <motion.div 
          className="absolute left-1/2 top-0 bottom-0 w-2 bg-gradient-to-b from-pink-400 via-purple-500 to-blue-500 transform -translate-x-1/2 pixel-border"
