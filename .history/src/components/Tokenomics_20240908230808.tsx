...
import Tooltip from './Tooltip'; // Предполагается, что у вас есть компонент Tooltip
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-pink-400 to-purple-500 rounded-lg p-8 shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <PieChart
                data={tokenomicsData.map((item, index) => ({
                  title: item.title,
        ...
        <div className="mt-12 text-center">
          <button 
            ...
            onClick={() => {
              // Здесь можно добавить логику для запуска демо-версии мини-игры
