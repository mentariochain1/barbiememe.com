...
const Hero: React.FC = () => {
  return (
    <div className="flex flex-col items-center w-full pt-4 sm:pt-8 md:pt-12 px-4 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-center w-full">
        <button 
          className="px-8 py-4 bg-pink-500 text-white font-bold text-lg rounded-md transition-all duration-300 transform hover:scale-105 sm:w-64"
          style={{ 
            fontFamily: '"Press Start 2P", cursive',
        ...
        <button 
          className="px-8 py-4 bg-cyan-400 text-white font-bold text-lg rounded-md transition-all duration-300 transform hover:scale-105 sm:w-64"
          style={{ 
            fontFamily: '"Press Start 2P", cursive',
