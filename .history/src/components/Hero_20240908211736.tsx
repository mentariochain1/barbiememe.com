...
const Hero: React.FC = () => {
  return (
    <div className="flex flex-col items-center w-full pt-4 sm:pt-8 md:pt-12 px-4">
      <h1 className="sega-barbie-title mb-6 text-center" style={{ fontFamily: '"Press Start 2P", cursive' }}>
        <span className="block transform -rotate-6 scale-y-125 origin-left">Welcome to</span>
        <span className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl mt-2 mb-3 transform rotate-6 scale-y-125 origin-right">
          $Barbie World
        </span>
      </h1>
