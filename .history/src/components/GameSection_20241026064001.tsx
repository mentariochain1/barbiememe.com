  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          🎮 $BARBIE MEGA GAME EVENT 🎮
        </motion.h2>
        <motion.div 
          className="text-center mb-12 bg-pink-500 p-6 rounded-lg shadow-lg"
          variants={itemVariants}
          style={{
            boxShadow: '0 0 20px #FF1493, 0 0 40px #4B0082',
          }}
        >
          <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4 text-white pixel-font font-bold animate-bounce">
            WIN BIG: 150 TON! 💎💰
          </h3>
          <p className="text-xl sm:text-2xl md:text-3xl text-white pixel-font mb-4">
            That's right, dolls! A whopping 150 TON up for grabs!
          </p>
        </motion.div>
        <motion.div className="text-center mb-12" variants={itemVariants}>
          <p className="mb-6 text-base sm:text-lg md:text-xl lg:text-2xl text-white pixel-font">
            🌟 Step into the glittery arena and turn your $BARBIE dreams into a high-score reality! 🌟
          </p>
          <p className="mb-8 text-base sm:text-lg md:text-xl lg:text-2xl text-white pixel-font">
            👑 Rack up those points like they're designer shoes! The player with the highest score doesn't just win – they strut away with a fabulous $BARBIE jackpot! 👑
          </p>
        </motion.div>
        <motion.div className="text-center" variants={itemVariants}>
          ...
          >
            <button 
              className="px-8 py-4 bg-pink-500 text-white font-bold text-lg rounded-md transition-all duration-300 hover:scale-105 hover:brightness-110 pixel-font animate-pulse"
              style={{ 
