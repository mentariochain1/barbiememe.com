    ...
    <div className="flex flex-col items-center w-full pt-4 sm:pt-8 md:pt-12 px-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative group">
          ...
          ></button>
          <button 
            className="relative px-6 py-3 bg-pink-500 text-white font-bold text-base rounded-sm hover:bg-pink-600 transition-colors duration-300"
            style={{ fontFamily: '"Press Start 2P", cursive' }}
          >
            BUY $BARBIE
          </button>
        ...
        <div className="relative group">
          ...
          ></button>
          <button 
            className="relative px-6 py-3 bg-green-300 text-white font-bold text-base rounded-sm hover:bg-green-400 transition-colors duration-300"
            style={{ fontFamily: '"Press Start 2P", cursive' }}
          >
            JOIN THE COMMUNITY
          </button>
