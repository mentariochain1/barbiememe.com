      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center space-x-8 mb-12">
          <a href="#" className="transform hover:scale-110 transition-transform duration-300">
            <Image src="/assets/telegram-icon.png" alt="Telegram" width={48} height={48} />
          </a>
          <a href="#" className="transform hover:scale-110 transition-transform duration-300">
            <Image src="/assets/twitter-icon.png" alt="Twitter" width={48} height={48} />
          </a>
        </div>
        <p className="text-sm text-center max-w-3xl mx-auto mb-12 leading-relaxed">
          $BRAT is an entertainment-based cryptocurrency with no formal affiliations. Any elements inspired by internet culture are for comedic purposes only. Investing in meme tokens, including $BRAT, carries several risks. Please conduct thorough research and consult with financial advisors before making any investment decisions.
        </p>
