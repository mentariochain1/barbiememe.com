  ...
  const captureAvatar = async () => {
    if (avatarRef.current) {
      ...
      try {
        ...
        gradient.setAttribute('id', 'avatarGradient');
        gradient.innerHTML = `
        ...
        background.setAttribute('fill', 'url(#avatarGradient)');
        ...
        foreignObject.setAttribute('x', ((600 - rect.width) / 2).toString());
        foreignObject.setAttribute('y', ((600 - rect.height) / 2).toString());

        const avatarClone = avatarElement.cloneNode(true) as HTMLElement;
        foreignObject.appendChild(avatarClone);
