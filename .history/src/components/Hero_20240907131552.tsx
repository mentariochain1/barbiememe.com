    ...
    <div className="flex flex-col items-center w-full pt-4 sm:pt-8 md:pt-12 px-4">
      <h1 
        ...
        style={{ 
          ...
          color: '#FFFFFF',
          textShadow: '2px 2px 0px #FF69B4, 4px 4px 0px #9C27B0',
          WebkitTextStroke: '1px #FF1493'
        }}
      >
        Welcome to
        <br />
        <span className="relative inline-block mt-2 mb-3 transform hover:scale-110 transition-transform duration-300 text-fuchsia-300">
          $Barbie
          <span 
      ...
      <div className="w-48 h-1 bg-gradient-to-r from-pink-300 via-fuchsia-400 to-purple-400 rounded-full mb-4"></div>
