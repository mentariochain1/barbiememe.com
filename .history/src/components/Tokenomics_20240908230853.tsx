...
import { PieChart, PieChartData } from 'react-minimal-pie-chart'; // Добавим тип PieChartData
import Tooltip from './Tooltip'; // Убедитесь, что этот компонент существует
...
const Tokenomics: React.FC = () => {
  ...
  const chartData: PieChartData = tokenomicsData.map((item, index) => ({
    title: item.title,
